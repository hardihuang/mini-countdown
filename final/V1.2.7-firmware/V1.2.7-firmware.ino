...
================================================================================
  ...
  mini countdown V1.2.7 firmware
  by Hardi Huang  (March 10 2019)
...
---------------------------------------
  if you want to edit the firmware by yourself, please open this file with Arduino IDE,
  and install all the librares first before upload this code to the ATmega 328P
  Please Enjoy!
...
------------------------------------------------
  ...
  V1.2.7 Mar/10/2019 21:39 disable power off while charging
...
int keyArray[] = {btnLeft, btnRight, btnSet, btnA, btnB, btnC}; 
int lastKey;
...
void autoPowerOff(){
  if(key!="0"){
    ...
    if(state == 0 || countDownData[2]==0){
		if(chargingState == 0){//not charging
			digitalWrite(power,LOW);
		}
